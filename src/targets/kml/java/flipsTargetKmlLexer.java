// $ANTLR 3.2 Sep 23, 2009 12:02:23 flipsTargetKml.g 2010-06-03 21:54:22
...
public class flipsTargetKmlLexer extends Lexer {
    ...
    public final void mTRI() throws RecognitionException {
        try {
            int _type = TRI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:277:5: ( 'tri' | 'TRI' )
            int alt21=2;
    ...
    public final void mCMD() throws RecognitionException {
        try {
            int _type = CMD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:279:5: ( 'cmd' | 'CMD' )
            int alt22=2;
    ...
    public final void mPAR() throws RecognitionException {
        try {
            int _type = PAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:280:5: ( 'par' | 'PAR' )
            int alt23=2;
    ...
    public final void mTIM() throws RecognitionException {
        try {
            int _type = TIM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:282:5: ( 'tim' | 'TIM' )
            int alt24=2;
    ...
    public final void mRAD() throws RecognitionException {
        try {
            int _type = RAD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:284:5: ( 'rad' | 'RAD' )
            int alt25=2;
    ...
    public final void mDIR() throws RecognitionException {
        try {
            int _type = DIR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:285:5: ( 'dir' | 'DIR' )
            int alt26=2;
    ...
    public final void mCCW() throws RecognitionException {
        try {
            int _type = CCW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:289:5: ( 'ccw' | 'CCW' )
            int alt28=2;
    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:294:2: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // flipsTargetKml.g:294:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            ...
            // flipsTargetKml.g:294:28: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop29:
            do {
                int alt29=2;
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:297:2: ( '\"' (~ ( '\"' ) )* '\"' )
            // flipsTargetKml.g:297:5: '\"' (~ ( '\"' ) )* '\"'
            {
            match('\"'); 
            // flipsTargetKml.g:297:9: (~ ( '\"' ) )*
            loop30:
            do {
                int alt30=2;
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // flipsTargetKml.g:302:7: ( '0' .. '9' )
            // flipsTargetKml.g:302:9: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mNonZeroDigit() throws RecognitionException {
        try {
            // flipsTargetKml.g:306:2: ( '1' .. '9' )
            // flipsTargetKml.g:306:4: '1' .. '9'
            {
            matchRange('1','9'); 
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // flipsTargetKml.g:313:9: ( Digit | 'a' .. 'f' | 'A' .. 'F' )
            // flipsTargetKml.g:
            {
    ...
    public final void mBinaryLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:316:2: ( '0' ( 'b' | 'B' ) ( BinaryDigit )+ )
            // flipsTargetKml.g:316:4: '0' ( 'b' | 'B' ) ( BinaryDigit )+
            {
            match('0'); 
            ...
            // flipsTargetKml.g:316:18: ( BinaryDigit )+
            int cnt31=0;
            loop31:
            do {
                int alt31=2;
    ...
    public final void mOctalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:319:2: ( '0' ( '0' .. '7' )+ )
            // flipsTargetKml.g:319:4: '0' ( '0' .. '7' )+
            {
            match('0'); 
            // flipsTargetKml.g:319:8: ( '0' .. '7' )+
            int cnt32=0;
            loop32:
            do {
                int alt32=2;
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:322:2: ( '0' | NonZeroDigit ( Digit )* )
            int alt34=2;
            ...
            switch (alt34) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // flipsTargetKml.g:322:8: NonZeroDigit ( Digit )*
                    {
                    mNonZeroDigit(); 
                    // flipsTargetKml.g:322:21: ( Digit )*
                    loop33:
                    do {
                        int alt33=2;
    ...
    public final void mHexLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:325:2: ( '0' ( 'x' | 'X' ) ( HexDigit )+ )
            // flipsTargetKml.g:325:4: '0' ( 'x' | 'X' ) ( HexDigit )+
            {
            match('0'); 
            if ( input.LA(1)=='X'||input.LA(1)=='x' ) {
                input.consume();
            ...
            // flipsTargetKml.g:325:18: ( HexDigit )+
            int cnt35=0;
            loop35:
            do {
                int alt35=2;
    ...
    public final void mFloatingPointLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:328:2: ( ( Digit )+ '.' ( Digit )* ( Exponent )? | '.' ( Digit )+ ( Exponent )? | ( Digit )+ Exponent )
            int alt42=3;
            alt42 = dfa42.predict(input);
            switch (alt42) {
                case 1 :
                    // flipsTargetKml.g:328:4: ( Digit )+ '.' ( Digit )* ( Exponent )?
                    {
                    // flipsTargetKml.g:328:4: ( Digit )+
                    int cnt36=0;
                    loop36:
                    do {
                        int alt36=2;
                    ...
                    // flipsTargetKml.g:328:22: ( Exponent )?
                    int alt38=2;
                    ...
                    break;
                case 2 :
                    // flipsTargetKml.g:329:17: '.' ( Digit )+ ( Exponent )?
                    {
                    match('.'); 
                    // flipsTargetKml.g:329:21: ( Digit )+
                    int cnt39=0;
                    loop39:
                    do {
                        int alt39=2;
                    ...
                    // flipsTargetKml.g:329:28: ( Exponent )?
                    int alt40=2;
                    ...
                    break;
                case 3 :
                    // flipsTargetKml.g:330:11: ( Digit )+ Exponent
                    {
                    // flipsTargetKml.g:330:11: ( Digit )+
                    int cnt41=0;
                    loop41:
                    do {
                        int alt41=2;
    ...
    public final void mExponent() throws RecognitionException {
        try {
            // flipsTargetKml.g:334:9: ( ( 'e' | 'E' ) ( '+' | '-' )? ( Digit )+ )
            // flipsTargetKml.g:334:11: ( 'e' | 'E' ) ( '+' | '-' )? ( Digit )+
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:338:4: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )+ )
            // flipsTargetKml.g:338:6: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )+
            {
            // flipsTargetKml.g:338:6: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )+
            int cnt45=0;
            loop45:
    ...
    public final void mComment() throws RecognitionException {
        try {
            int _type = Comment;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:342:9: ( '/*' ( options {greedy=FALSE; } : . )* '*/' )
            // flipsTargetKml.g:342:11: '/*' ( options {greedy=FALSE; } : . )* '*/'
            {
            match("/*"); 

            // flipsTargetKml.g:342:16: ( options {greedy=FALSE; } : . )*
            loop46:
            do {
                int alt46=2;
    ...
    public final void mLineComment() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // flipsTargetKml.g:345:2: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
            // flipsTargetKml.g:345:4: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
            {
            match("//"); 

            // flipsTargetKml.g:345:9: (~ ( '\\n' | '\\r' ) )*
            loop47:
            do {
                int alt47=2;
    ...
    public void mTokens() throws RecognitionException {
        // flipsTargetKml.g:1:8: ( T__52 | FLY | LTR | FIX | REL | POS | X | Y | Z | GEO | ROL | PIT | YAW | PRE | VEL | SPD | AIR | GND | ACT | ELE | AIL | RUD | FLA | THR | TRI | CMD | PAR | TIM | RAD | DIR | L | R | CW | CCW | Identifier | StringLiteral | BinaryLiteral | OctalLiteral | DecimalLiteral | HexLiteral | FloatingPointLiteral | WS | Comment | LineComment )
        int alt49=44;
        alt49 = dfa49.predict(input);
        switch (alt49) {
            case 1 :
                // flipsTargetKml.g:1:10: T__52
                {
                mT__52(); 
            ...
            case 34 :
                ...
                break;
            case 35 :
                // flipsTargetKml.g:1:137: Identifier
                {
                mIdentifier(); 
                ...
                break;
            case 36 :
                // flipsTargetKml.g:1:148: StringLiteral
                {
                mStringLiteral(); 
                ...
                break;
            case 37 :
                // flipsTargetKml.g:1:162: BinaryLiteral
                {
                mBinaryLiteral(); 
                ...
                break;
            case 38 :
                // flipsTargetKml.g:1:176: OctalLiteral
                {
                mOctalLiteral(); 
                ...
                break;
            case 39 :
                // flipsTargetKml.g:1:189: DecimalLiteral
                {
                mDecimalLiteral(); 
                ...
                break;
            case 40 :
                // flipsTargetKml.g:1:204: HexLiteral
                {
                mHexLiteral(); 
                ...
                break;
            case 41 :
                // flipsTargetKml.g:1:215: FloatingPointLiteral
                {
            ...
            case 42 :
                ...
                break;
            case 43 :
                // flipsTargetKml.g:1:239: Comment
                {
                mComment(); 
                ...
                break;
            case 44 :
                // flipsTargetKml.g:1:247: LineComment
                {
                mLineComment(); 
    ...
    class DFA42 extends DFA {
        ...
        public String getDescription() {
            return "327:1: FloatingPointLiteral : ( ( Digit )+ '.' ( Digit )* ( Exponent )? | '.' ( Digit )+ ( Exponent )? | ( Digit )+ Exponent );";
        }
    }
