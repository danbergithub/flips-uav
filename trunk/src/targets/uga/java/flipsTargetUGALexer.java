...
public class flipsTargetUGALexer extends Lexer {
    ...
    public void mTokens() throws RecognitionException {
        // flipsTargetUGA.g:1:8: ( T__54 | FLY | LTR | FIX | REL | POS | X | Y | Z | GEO | ROL | PIT | YAW | PRE | VEL | SPD | AIR | GND | ACT | ELE | AIL | RUD | FLA | THR | PCT | RPM | TRI | CMD | PAR | TIM | RAD | DIR | L | R | CW | CCW | Identifier | StringLiteral | BinaryLiteral | OctalLiteral | DecimalLiteral | HexLiteral | FloatingPointLiteral | WS | Comment | LineComment )
        int alt51=46;
        alt51 = dfa51.predict(input);
        switch (alt51) {
            case 1 :
                // flipsTargetUGA.g:1:10: T__54
                {
                mT__54(); 
            ...
            case 36 :
                ...
                break;
            case 37 :
                // flipsTargetUGA.g:1:145: Identifier
                {
                mIdentifier(); 
                ...
                break;
            case 38 :
                // flipsTargetUGA.g:1:156: StringLiteral
                {
                mStringLiteral(); 
                ...
                break;
            case 39 :
                // flipsTargetUGA.g:1:170: BinaryLiteral
                {
                mBinaryLiteral(); 
                ...
                break;
            case 40 :
                // flipsTargetUGA.g:1:184: OctalLiteral
                {
                mOctalLiteral(); 
                ...
                break;
            case 41 :
                // flipsTargetUGA.g:1:197: DecimalLiteral
                {
                mDecimalLiteral(); 
                ...
                break;
            case 42 :
                // flipsTargetUGA.g:1:212: HexLiteral
                {
                mHexLiteral(); 
                ...
                break;
            case 43 :
                // flipsTargetUGA.g:1:223: FloatingPointLiteral
                {
            ...
            case 44 :
                ...
                break;
            case 45 :
                // flipsTargetUGA.g:1:247: Comment
                {
                mComment(); 
                ...
                break;
            case 46 :
                // flipsTargetUGA.g:1:255: LineComment
                {
                mLineComment(); 
